...
export default function Home() {
  ...
  return (
    <>
      <PageSEO />
      <Head>
        <title>Konveksi Tangerang</title>
          ...
          <section aria-labelledby="category-heading" className="bg-gray-50">
            <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
              <div className="sm:flex sm:items-baseline sm:justify-between">
                ...
                <a
                  href="#"
                  className="hidden text-sm font-semibold text-black hover:text-zinc-500 sm:block"
                >
              ...
              <div className="mt-6 sm:hidden">
                <a
                  href="#"
                  className="block text-sm font-semibold text-black hover:text-zinc-500"
                >
                  Browse all categories
                  <span aria-hidden="true"> &rarr;</span>
                </a>
              ...
              <div className="mt-16 md:mt-16 xl:mt-0">
                ...
                <form className="mt-2 flex sm:max-w-md">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="w-full min-w-0 appearance-none rounded-md border border-gray-300 bg-white px-4 py-2 text-base text-zinc-500 placeholder-gray-500 shadow-sm focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500"
                  />
                  <div className="ml-4 flex-shrink-0">
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center rounded-md border border-transparent bg-black px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2"
                    >
                      Sign up
                    </button>
                  </div>
